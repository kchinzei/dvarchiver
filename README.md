...
CLI Tools and workflow to organize DV (digital video) for archiving
...
See usage, possible options at the bottom of this readme.
...
As-is '.dv' files are not suitable for sharing with others because,
...
| `-b sec`, `--begin sec`| Begin rendering date/time, in second |
